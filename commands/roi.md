...
2. Build the ROI framework in the shape of Section 4 of the template:
   ...
   - **Per-wave targets**: conservative, sourced from the pilot with the haircut stated.
...
5. Offer to write it into Section 4 of `rollout_plan_FINAL.md`.
